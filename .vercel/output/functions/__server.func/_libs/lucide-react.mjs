...
const Bookmark = createLucideIcon("bookmark", __iconNode$I);
const __iconNode$H = [
...
const BotMessageSquare = createLucideIcon("bot-message-square", __iconNode$H);
const __iconNode$G = [
  [
    "path",
    {
...
const Boxes = createLucideIcon("boxes", __iconNode$F);
const __iconNode$E = [
