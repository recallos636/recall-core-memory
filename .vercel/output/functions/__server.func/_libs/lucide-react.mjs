...
const BotMessageSquare = createLucideIcon("bot-message-square", __iconNode$J);
const __iconNode$I = [
  [
    "path",
    {
...
const Code = createLucideIcon("code", __iconNode$w);
const __iconNode$v = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
  [
    "path",
...
const FolderGit2 = createLucideIcon("folder-git-2", __iconNode$o);
const __iconNode$n = [
  [
    "path",
    {
...
const MessagesSquare = createLucideIcon("messages-square", __iconNode$g);
const __iconNode$f = [
