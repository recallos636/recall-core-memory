...
export function GradientButton({
  ...
  const styles: Record<Variant, string> = {
    primary:
      "text-[#0c0c0c] bg-gradient-to-b from-[#A4F4FD] to-[#00d2ff] shadow-[0_10px_40px_-10px_rgba(0,210,255,0.6),inset_0_1px_0_rgba(255,255,255,0.6)] hover:shadow-[0_18px_50px_-10px_rgba(0,210,255,0.8),inset_0_1px_0_rgba(255,255,255,0.7)] hover:-translate-y-0.5",
    ghost:
